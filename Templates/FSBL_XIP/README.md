...
- Select `target` and **FSBL_XIP** (from DFP) and click **Create**
...
> [STM32N6570-DK board](https://github.com/Open-CMSIS-Pack/STM32N6570-DK_BSP/blob/main/Examples/FSBL_XIP/Configuration.md#configuration-in-stm32cubemx) STM32CubeMX configuration 
...
> [STM32N6570-DK board](https://github.com/Open-CMSIS-Pack/STM32N6570-DK_BSP/blob/main/Examples/FSBL_XIP/Configuration.md#configuration-in-vscode) VSCode configuration 
